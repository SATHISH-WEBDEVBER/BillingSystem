      ...
      <div className="bills-grid">
        {recentBills.length > 0 ? recentBills.map((bill) => (
            <div key={bill._id} className="bill-card" onClick={() => onViewBill(bill)}>
              <div className="card-preview"><div className="mini-bill-wrapper"><BillPreview data={{...bill, billDate: bill.date, clientName: bill.client.name, paymentMode: bill.paymentMode || "Credit", shopMobile: "6385278892"}} items={bill.items} totals={bill.totals} /></div></div>
