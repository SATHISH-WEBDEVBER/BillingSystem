...
router.post('/save', async (req, res) => {
  const { billNo, date, client, items, totals, paymentMode } = req.body; // ADDED paymentMode
  try {
    const newBill = new Bill({ billNo, date, client, items, totals, paymentMode }); // ADDED paymentMode
    await newBill.save();
